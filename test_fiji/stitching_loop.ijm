...
mainDirectory = getArgument();
mainDirectory = mainDirectory + "/test/";

    // Use the fullPath as needed, for example, to open an image
print("Full path: " + mainDirectory);
...
for (i=0; i<=list.length-1; i=i+1){
	 if(startsWith(list[i],"20220504_2300_Plate02")) {
